-- simple that maps the combined country and publication type information to the type of patent document (e.g., granted, applied, utility, etc.)
select
  ...
  from (
    SELECT Simple_family_ID, First_priority_date, Publication_type, publication_country,
      CASE
        ...
        when publication_country = "US" and Publication_type in ("A1", "A2", "A9") then 'Utility Patent Application'
        when publication_country = "US" and Publication_type in ("B1", "B2") then 'Granted Utility Patent'
